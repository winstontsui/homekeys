  ...
  return (
    <header className="w-full py-4 px-6 md:px-10 border-b flex items-center justify-between">
      ...
      <nav className="hidden md:flex items-center space-x-8">
        <NavLink to="/" className={({ isActive }) => isActive ? 'text-blue-700' : 'text-gray-700 hover:text-gray-900'}>
          Explore Listings
        </NavLink>
        <NavLink to="/map" className={({ isActive }) => isActive ? 'text-blue-700' : 'text-gray-700 hover:text-gray-900'}>
          Map View
        </NavLink>
        <NavLink to="/dashboard" className={({ isActive }) => isActive ? 'text-blue-700' : 'text-gray-700 hover:text-gray-900'}>
          Dashboard
        </NavLink>
